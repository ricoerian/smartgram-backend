...
class FaceRestorer:
    def __init__(self, model_path: str = "weights/GFPGANv1.4.onnx", providers=['CUDAExecutionProvider', 'CPUExecutionProvider']):
    ...
    def restore_image(self, image: Union[Image.Image, np.ndarray]) -> Image.Image:
        """
